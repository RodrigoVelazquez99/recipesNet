# Generated by Django 3.0.9 on 2020-08-14 03:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Admin',
            fields=[
                ('email', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='database.User')),
            ],
            options={
                'db_table': 'admin',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followers', models.ManyToManyField(related_name='followees', to='database.Chef')),
            ],
            options={
                'db_table': 'chef',
            },
